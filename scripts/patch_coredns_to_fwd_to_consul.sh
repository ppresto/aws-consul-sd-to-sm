...
CORE_DNS_TMPL_DIR="${SCRIPT_DIR}/../quickstart/templates/coredns-1.28"
...
kubectl -n kube-system get configmap/coredns -o yaml > ${SCRIPT_DIR}/../logs/kube-system-coredns-configmap-orig.yaml
echo "Backing up original coredns config to ${SCRIPT_DIR}/../logs/kube-system-coredns-configmap-orig.yaml"
